...
\vspace{-.2em}
{\color{accent}\faLink\textbf{Complete list:}}
	\href{https://dariotrinchero.github.io/talks/}{https://dariotrinchero.github.io/talks/}
\smallskip
...
\cvsubsection{2023--2026: Doctorate in Mathematical Physics}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Winning team: \href{https://appliedmaths.sun.ac.za/sammc.html}%
		{South African Mathematical Modelling Contest} (2018)
    \item Second place team: \href{https://www.csc.ac.za/?page_id=665}%
...
%     \item Winning team: South African Mathematical Modelling Contest
%     \item Second place team: \emph{SANReN} Cyber Security Challenge
%     \item Stellenbosch University Merit Award bursary
% \end{itemize}
...
\cvsubsection{2015--2016: Cambridge A-levels}
\begin{itemize}
    ...
    \item Winning team: \href{https://sadebating.org/phalaborwa-2016/}{SA National Debating Championship};
		10\textsuperscript{th} individually
...
% -----------------------------------------------------------------------------------------------------------------------
\cvevent{Mathematics Lecturer}{}{Feb 2024 -- Jul 2024}{Stellenbosch University, ZA}
\smallskip
...
\medskip
\begin{itemize}
\item \makebox[4.1em][l]{\emph{3rd year:}} Algebra, real analysis, Fredholm theory
...
\cvproject{Learning isiXhosa (since 2025)}
\begin{itemize}
	\item I am self-studying isiXhosa.
	\item This Bantu language is an official language of South Africa, widely spoken in my home city
	of Cape Town.
\end{itemize}
\medskip

\cvproject{Exploring Philosophy (since 2021)}
\begin{itemize}
	\item I have an avid interest in philosophy, and spend a lot of free time working through papers
		\& textbooks.
	\item I presented a talk in 2024 at the Stellenbosch philosophy club on a famous (alleged)
		\href{https://dariotrinchero.github.io/talks/2024-08-30-modal}{mathematical proof of God}.
	\item My passion is mostly for contemporary ethics \& logic, but I also enjoy studying philosophy of
		science, epistemology, \& religious philosophy.
\end{itemize}
\medskip

\cvproject{Game Development (since 2019)}
\begin{itemize}
...
\cvproject{Coding Challenges (since 2015)}
\begin{itemize}
...
% TODO Possibly re-include the below? It seemed a little old & trivial to me.
%\cvproject{Enrichment Courses (2019)}
%\begin{itemize}
...
%\smallskip
%
%\cvproject{Algebra \& Geometry Investigation (2017--2018)}
%\begin{itemize}
